...
class _IntroductionState extends State<Introduction>
  ...
  void initState() {
    ...
    DbHelper.updateDbMateriProgressJs(0);
    ...
    if (tabController.indexIsChanging) {
      switch (tabController.index) {
        case 0:
          ...
          break;
        case 1:
          DbHelper.updateDbInteraktifProgressJs(0, 0, 100);
          setState(() {
  ...
  String textInteraktif() {
    return """<!DOCTYPE html>\n<html lang="en" dir="ltr">\n  <body>\n    <h4>Pengenalan JavaScript</h4>\n  </body>\n  <script type="text/javascript"></script>\n</html>""";
  }

  String textExeInteraktif() {
    return """<!DOCTYPE html><html lang="en" dir="ltr">  <body>    <h4>Pengenalan JavaScript</h4>  </body>  <script type="text/javascript"></script></html>""";
  }
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(children: [
                          const Text(
                            "  Javascript merupakan bahasa pemrograman berbasis Java yang diterapkan pada halaman web. Javascript digunakan untuk membuat halaman web menjadi lebih interaktif karena adanya action dari komponen HTML. Terdapat beberapa event pada komponen HTML yang dapat diberikan action dengan Javascript, yaitu sebagai berikut.",
                            style: TextStyle(fontSize: 12),
                          ),
                          SvgPicture.asset(
                            "assets/img/img_introjs.svg",
                            width: MediaQuery.of(context).size.width,
                          ),
                          const Text(
                            """Terdapat tiga cara letak penulisan script Javascript, yaitu inline, embedded (internal), dan linked (external).
Tata cara penulisan tipe inline, diletakkan pada event pada komponen HTML seperti contoh berikut.""",
                            style: TextStyle(fontSize: 12),
                          ),
                          Container(
                          ...
                          const Text(
                            "Tata cara penulisan tipe embedded (internal), diletakkan pada bagian tag <head> dengan diapit tag <script></script> seperti contoh berikut ini.",
                            style: TextStyle(fontSize: 12),
                          ),
                          Container(
                            padding: const EdgeInsets.symmetric(vertical: 5),
	...
	<script>
		function tes() {
			alert(“Hello World”);
                          ...
                          const Text(
                            "Tata cara penulisan tipe linked (external), dipisahkan antara file HTML dan file Javacript-nya. Kemudian untuk menghubungkan file Javascript ke file HTML menggunakan kode serti berikut.",
                            style: TextStyle(fontSize: 12),
                          ),
                          Container(
                            padding: const EdgeInsets.symmetric(vertical: 5),
                          ...
                          const Text(
                            "Seperti pemrograman Java, Javascript juga mengenal variabel, operator, tipe data, percabangan, perulangan, array dan function. Berikut ini akan kita bahas satu persatu tentang konsep tersebut.",
                            style: TextStyle(fontSize: 12),
                          )
                        ]),
                      ),
