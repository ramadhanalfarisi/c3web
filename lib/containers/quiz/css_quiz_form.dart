...
class CssQuizForm extends StatefulWidget {
  const CssQuizForm({super.key});

  @override
  State<CssQuizForm> createState() => _CssQuizFormState();
}

class _CssQuizFormState extends State<CssQuizForm> {
  List<Widget> carouselQuiz = [];
  List<String> answers = [];
  List<String> currentAnswers = [];
  late Box<CssQuiz> box;
  String currentKey = "";
  ...
  initializeBox() async {
    box = await Hive.openBox<CssQuiz>('css_quiz_box');
    List<Container> car = [];
    List<String> ans = [];
